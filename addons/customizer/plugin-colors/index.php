...
?>
    ...
    <style type="text/css">
		...
		.ui-tooltip.nd_cc_tooltip_jquery_content { background-color: <?php echo esc_attr($nd_cc_customizer_color_dark_1);  ?>; }
		#nd_cc_search_filter_options li p { border-bottom: 2px solid <?php echo esc_attr($nd_cc_customizer_color_dark_1);  ?>;}
		#nd_cc_checkout_payment_tab_list li.ui-state-active { border-bottom: 1px solid <?php echo esc_attr($nd_cc_customizer_color_dark_1);  ?>;}
		.nd_cc_border_1_solid_greydark_important { border: 1px solid <?php echo esc_attr($nd_cc_customizer_color_dark_1);  ?> !important;}

		/*color_dark_2*/
		.nd_cc_bg_greydark_2 { background-color: <?php echo esc_attr($nd_cc_customizer_color_dark_2);  ?>; }
		.nd_cc_bg_greydark_2_important { background-color: <?php echo esc_attr($nd_cc_customizer_color_dark_2);  ?> !important; }
		
		/*color_1*/
		.nd_cc_bg_yellow, .nd_cc_btn_pagination_active { background-color: <?php echo esc_attr($nd_cc_customizer_color_1);  ?>; }
		.nd_cc_color_yellow_important { color: <?php echo esc_attr($nd_cc_customizer_color_1);  ?> !important ; }

		/*color_2*/
		.nd_cc_bg_red { background-color: <?php echo esc_attr($nd_cc_customizer_color_2);  ?>; }
