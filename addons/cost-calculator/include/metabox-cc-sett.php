        ...
        <div class="nd_cc_id_metabox_cpt_content">
            <div id="nd_cc_tab_main">
                ...
                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    <p><strong><?php esc_html_e('Main Color','nd-projects'); ?></strong></p>
                    ...
                    <p><?php esc_html_e('Set the main color of your cost calculator','nd-projects'); ?></p>
                ...
                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    <p><strong><?php esc_html_e('Layout','nd-projects'); ?></strong></p>
                    
                    <select class="nd_cc_width_100_percentage" name="nd_cc_meta_box_cc_layout" id="nd_cc_meta_box_cc_layout">
        
                      <option <?php if( $nd_cc_meta_box_cc_layout == 1 ) { echo esc_html('selected="selected"'); } ?> value="1"><?php esc_html_e('Layout 1','nd-projects'); ?></option>
                      <option <?php if( $nd_cc_meta_box_cc_layout == 2 ) { echo esc_html('selected="selected"'); } ?> value="2"><?php esc_html_e('Layout 2','nd-projects'); ?></option>
                       
                    </select>


                    <p><?php esc_html_e('Set the layout that you want to use','nd-projects'); ?></p>
                </div>

                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    <p><strong><?php esc_html_e('LIMIT : Sections','nd-projects'); ?></strong></p>
                    ...
                    <p><?php esc_html_e('Set how many sections you would like to create','nd-projects'); ?></p>
                </div>

                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    <p><strong><?php esc_html_e('LIMIT : Sub Sections','nd-projects'); ?></strong></p>
                    ...
                    <p><?php esc_html_e('Set how many sub sections you would like to create','nd-projects'); ?></p>
                </div>

                <div class="nd_cc_section nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    <p><strong><?php esc_html_e('LIMIT : Repeater Fields','nd-projects'); ?></strong></p>
                    ...
                    <p><?php esc_html_e('Set how many repeater fields you would like to create','nd-projects'); ?></p>
                </div>
            ...
            <div id="nd_cc_tab_price">
                ...
                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    <p><strong><?php esc_html_e('Title','nd-projects'); ?></strong></p>
                    ...
                    <p><?php esc_html_e('Set the tile for your price section','nd-projects'); ?></p>
                </div>

                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    <p><strong><?php esc_html_e('Description','nd-projects'); ?></strong></p>
                    ...
                    <p><?php esc_html_e('Set the description for your price section','nd-projects'); ?></p>
                </div>

                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    <p><strong><?php esc_html_e('Start Price','nd-projects'); ?></strong></p>
                    ...
                    <p><?php esc_html_e('Set the starting price of your cost calculator','nd-projects'); ?></p>
                </div>

                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    <p><strong><?php esc_html_e('Currency','nd-projects'); ?></strong></p>
                    ...
                    <p><?php esc_html_e('Insert the currency of your cost calculator','nd-projects'); ?></p>
                </div>

                <div class="nd_cc_section nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    <p><strong><?php esc_html_e('Icon','nd-projects'); ?></strong></p>
                    ...
                    <p><?php esc_html_e('Insert the url of your icon/image that you want to show at the end of the cost calculator','nd-projects'); ?></p>
                </div>
