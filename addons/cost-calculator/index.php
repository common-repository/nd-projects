...
include realpath( dirname( __FILE__ ).'/include/functions.php' );
...
function nd_cc_metabox_cost_calc_short(){
    echo esc_html('[nd_cost_calculator id="'.get_the_ID().'"]');
}

include realpath( dirname( __FILE__ ).'/include/metabox-cc.php' );
include realpath( dirname( __FILE__ ).'/include/metabox-cc-sett.php' );
include realpath( dirname( __FILE__ ).'/include/metabox-cc-save.php' );
include realpath( dirname( __FILE__ ).'/include/shortcode.php' );
